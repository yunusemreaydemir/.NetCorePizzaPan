...
namespace Pizzapan.PresentationLayer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFootersService, FootersManager>();
            services.AddScoped<IFootersDal, EfFootersDal>();

            services.AddScoped<IAboutMenuService, AboutMenuManager>();
            services.AddScoped<IAboutMenuDal, EfAboutMenuDal>();
