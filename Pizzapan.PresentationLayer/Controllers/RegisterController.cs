    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Index(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                MailboxAddress mailboxAddressFrom = new MailboxAddress("Admin", "yunusemreaydemir016@gmail.com");
                ...
                smtpClient.Authenticate("yunusemreaydemir016@gmail.com", "yakrgmabykzhndyc");
